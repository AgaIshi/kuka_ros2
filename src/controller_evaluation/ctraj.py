...
class CTrajPublisher(Node):
    def __init__(self):
        ...
        # Position increment
        # target = [0.70602, -0.022508, 0.32752]
        # start = 
        self.step_size = np.array([-0.0, 0.10, 0.00])
    ...
    def compute_ctraj(self):
        ...
        print("First keyframe position: ", tg[0].t)
        self.trajectory = tg
    ...
    def publish_trajectory(self):
        ...
        if self.state == "initial_waiting":
            ...
            if self.initial_orientation is None:
                ...
                delta_ori = max(0.4, 1.1 * max(abs(self.step_orientation)))
                self.y_lim_x = (
        ...
        self.get_logger().info("Published quat: " + str(target_pose.pose.orientation))
